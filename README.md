# Variational Encoder Forecasting Model with Pretraining

Variational Encoder Model implemented in TensorFlow+Keras for the Forecasting problem category as per Ready Tensor specifications. Model is pretrained using synthetically generated data and then fine-tuned on the actual data.
